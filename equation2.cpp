...
void equation_2::recalc_terms()
{
  ...
  std::cout << "Step 1 : " << equation_term << " * X^0 + " << equation_term_x << " * X^1 + " << equation_term_x2 << " * X^2 = " << equation_result_x << " * X^1 + " << equation_result_x2 << " * X^2" << std::endl;

  equation_term_x -= equation_result_x;
  std::cout << "Step 2 : " << equation_term << " * X^0 + " << equation_term_x << " * X^1 + " << equation_term_x2 << " * X^2 = " << equation_result_x2 << " * X^2" << std::endl;
...
{
  recalc_terms();
  std::cout << "Reduced form : " << equation_term << " * X^0 + " << equation_term_x << " * X^1 + " << equation_term_x2 << " * X^2 = 0" << std::endl;
  ...
  else
  {
    ...
    std::cout << "The two complexes solutions are : " << resre << " - " << resim << "i and " << resre << " + " << resim << "i" << std::endl;
  }
}
